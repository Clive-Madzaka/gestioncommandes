<?php
     ...
     if(!empty($_POST["inputnom"])&&!empty($_POST["inputville"])&&!empty($_POST["inputphone"])){
          $query="insert into clients(nom,ville,telephone) values (:nom,:ville,:telephone)";
          $pdostmt=$pdo->prepare($query);
          $pdostmt->execute(["nom"=>$_POST["inputnom"],"ville"=>$_POST["inputville"],"telephone"=>$_POST["inputphone"]]);
          $pdostmt->closeCursor();
...
?>
     ...
     <form class="row g-3" method="POST">
          ...
          <div class="col-md-6">
               ...
               <input type="text" class="form-control" id="inputvile" name="inputville" required>
          </div>
          <div class="col-12">
